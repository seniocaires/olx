...
//		Destination destination = broker.getSession().createQueue(Configuracao.BROKER_QUEE_REGIAO);
...
//		try {
//			regioes = (List<Regiao>) future.get(Configuracao.TIMEOUT_PROCESSAMENTO_SEGUNDOS, TimeUnit.SECONDS);
//			for (Regiao regiao : regioes) {
//				TextMessage textMessage = broker.getSession().createTextMessage(gson.toJson(regiao));
